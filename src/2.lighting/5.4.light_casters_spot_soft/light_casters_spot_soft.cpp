...
int main()
{
  ...
  Shader objShader("5.4.obj.vert", "5.4.obj.frag");
  Shader lightShader("5.4.light.vert", "5.4.light.frag");
  ...
  objShader.setVec3("light.diffuse", 0.9f, 0.9f, 0.9f);
  objShader.setVec3("light.specular", 2.0f, 2.0f, 2.0f);
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    objShader.setVec3("light.position", camera.Position.x, camera.Position.y, camera.Position.z);
    objShader.setVec3("light.direction", camera.Front.x, camera.Front.y, camera.Front.z);
